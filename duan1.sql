...
(10, 'administrator111', 'admin123', NULL, 'teddy.nam152@gmail.com', NULL, NULL, NULL, NULL, 0),
(11, 'admin123', 'admin123', NULL, 'teddy.nam152@gmail.com', NULL, NULL, NULL, NULL, 0);
...
ALTER TABLE `billdetails`
  ...
  ADD KEY `fk_my_category` (`category_id`),
...
ALTER TABLE `carts`
  ...
  ADD CONSTRAINT `carts_ibfk_2` FOREIGN KEY (`detail_id`) REFERENCES `product_detail` (`id`);
